module.exports = {
  define: function (orm, Model, target_model, fields, colParams) {
      ...
      extend: function (associations) {
        ...
        Model.hasOne = function () {
          ...
          associations.push({
            field: association,
            type: "one",
            target_model: target_model,  // this = circular reference
            source_model: this,
            opts: opts
          });

          helper.create(this, association, target_model);
        };
      },
      create: function (instance, association, associationModel) {
        ...
        instance.prototype["get" + camelCaseAssociation] = function () {
          ...
          if (this[association + "_id"] > 0) {
            ...
            var data = {}, conditions = {};
            data[target_model + "_id"] = this[idProperty];
