...
DBClient.prototype.saveRecord = function (idProp, collection, data, newRecord, callback) {
	/**
	 * Save a record. data is a hash with record data. if newRecord or data.id exists when idProp not null,
